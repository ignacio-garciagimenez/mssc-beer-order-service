...
import guru.sfg.brewery.model.events.AllocateOrderFailed;
...
public class BeerOrderManagerImplIT {
    ...
    @TestConfiguration
    static class ResTemplateBuilderProvider {
    ...
    void testFailedAllocation() throws JsonProcessingException {
        ...
        AllocateOrderFailed event = (AllocateOrderFailed) jmsTemplate.receiveAndConvert(JmsConfig.ALLOCATE_ORDER_FAILED_QUEUE);

        assertEquals(event.getOrderId(), savedBeerOrder.getId());
    }
    ...
    @Test
    void testCancelOrderWhenPendingValidation() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder()
                .id(beerId)
                .upc("12345")
                .build();
        ...
        assertEquals(BeerOrderStatusEnum.CANCELED, savedBeerOrder.getOrderStatus());
    }

    @Test
    void testCancelOrderWhenPendingAllocation() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder()
                .id(beerId)
                .upc("12345")
                .build();
    ...
    @Test
    void testCancelOrderWhenAllocated() throws JsonProcessingException {
        BeerDto beerDto = BeerDto.builder()
                .id(beerId)
                .upc("12345")
                .build();
